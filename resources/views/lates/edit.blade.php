...
<form method="post" action="{{ route('lates.update', $late['id']) }}" enctype="multipart/form-data">
    ...
    <div class="mb-4">
     ...
     <div class="mb-6">
      <label for="bukti" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Informasi</label>
      <input type="file" id="bukti" name="bukti" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('bukti') is-invalid @enderror" value="{{ old('bukti', $late->bukti) }}" required autofocus>
